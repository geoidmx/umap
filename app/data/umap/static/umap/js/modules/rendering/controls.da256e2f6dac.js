import{Control}from"../../../vendors/leaflet/leaflet-src.esm.8061ab6fa5db.js"
...
export const SearchControl=BaseButton.extend({options:{position:'topleft',title:translate('Search location'),className:'leaflet-control-search',icon:'icon-search',},afterAdd(container,map){this.layer=L.layerGroup().addTo(map)
