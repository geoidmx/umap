import{Popup as BasePopup,DomEvent,Path,}from"../../../vendors/leaflet/leaflet-src.esm.8061ab6fa5db.js"
import Browser from"../browser.b040ccaf2e3b.js"
import loadTemplate from"./template.4593e62ec798.js"
...
BasePopup.prototype.initialize.call(this,{},feature.ui)},loadContent:async function(){const container=document.createElement('div')
...
container.appendChild(DOMUtils.loadTemplate(`<h3>${this.feature.getDisplayName()}</h3>`))}
