...
async open(importer){const container=DomUtil.create('div')
container.innerHTML=TEMPLATE
if(this.expression){container.querySelector('[name=tags]').value=this.expression}
this.autocomplete=new Autocomplete(container.querySelector('#area'),{url:this.searchUrl,placeholder:translate('Type area name, or let empty to load data in current map view'),on_select:(choice)=>{this.boundaryChoice=choice},on_unselect:(choice)=>{this.boundaryChoice=null},})
